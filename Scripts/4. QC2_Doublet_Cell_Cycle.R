...
plot.df.hivpos <- FetchData(object = subset(seurat_phase,subset= `Condition` == 'HEI'), vars = c("PC_1", "PC_2", 
                                                                                                  "tricyclePosition", "TOP2A"))
plot.df.hivneg <- FetchData(object = subset(seurat_phase,subset= `Condition` == 'HEU'), vars = c("PC_1", "PC_2", 
                                                                                                  "tricyclePosition", "TOP2A"))
